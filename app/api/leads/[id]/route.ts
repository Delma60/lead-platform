...
export async function PATCH(request: NextRequest, context: RouteContext) {
  try {
    ...
    const [updated] = await db.update(leads).set({
      ...
      ...(update.rateScope !== undefined && { rateScope: normalizeOptionalText(update.rateScope ?? undefined) }),
      ...(update.contractSigned !== undefined && { contractSigned: update.contractSigned }),
      ...(update.depositPaid !== undefined && { depositPaid: update.depositPaid }),
